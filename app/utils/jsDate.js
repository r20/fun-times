/*
TBD - This is being used temporarily. It was found online (see comments below).
I may replace it with moment.js or something simple I create.
I never examined/tested this to make sure it's accurate. Whatever is
used MUST be perfectly accurate with leap years and seconds.

MY CHANGES:
- Added export for DateDiff definition
...
/* Original file changed to add export statement */
export const datediff = DateDiff;
