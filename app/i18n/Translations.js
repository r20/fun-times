...
export const en = {
  ...
  menuMilestoneSuggestionsTitle: "Milestones",
  ...
  subtitleCalendarScreen: "Celebration milestones on device calendar regardless of settings or stars.",
  ...
  calendarChangeColorConfirmation: 'The Fun Times calender on this device will need to be removed, then recreated with a new color, then milestones added back.\n\nThis may take a few seconds.  Do you want to proceed?',
  calendarChangeColorTitle: 'Change Calendar Color',
  selectColor: 'Change Color',
  calendarMaxNumMilestonesPerEventLabel: 'Show {{someValue}} milestones per favorite event.',
  allDay: 'All Day',
  ...
  emptyCustomEventsMessage: "Add birthdays, anniversaries, and other special occasions to discover upcoming celebration milestones.",
  ...
  emptyCalendarMessage: "There are no celebration milestones on the Fun Times calendar within \{{someValue}}\ days.",
  emptyMilestoneMessage: "There are no celebration milestones for favorite events that meet the settings criteria within the next \{{someValue}}\ days.",
